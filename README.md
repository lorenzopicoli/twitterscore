...
| --troll                     | Analyse only data labeled as troll (effectively filtering bots and legits from the analysis)                                                                                                                                                                                                                                                                                                                                                         |                                   | -c: "labeledData" |     |
...
| --troll                     | Analisa só os trolls conhecidos (filtrando bots e legits da análise)                                                                                                                                                                                                                                                                                                                                                         |                                   | -c: "labeledData" |     |
